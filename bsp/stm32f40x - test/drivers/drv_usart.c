...
#define USAR1Tx                           USART1
#define USAR1Tx_CLK_ENABLE()              __HAL_RCC_USART1_CLK_ENABLE();
#define USAR1Tx_RX_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOA_CLK_ENABLE()
#define USAR1Tx_TX_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOA_CLK_ENABLE() 

#define USAR1Tx_FORCE_RESET()             __HAL_RCC_USART1_FORCE_RESET()
#define USAR1Tx_RELEASE_RESET()           __HAL_RCC_USART1_RELEASE_RESET()
...
#define USAR6Tx                           USART6
#define USAR6Tx_CLK_ENABLE()              __HAL_RCC_USART6_CLK_ENABLE();
#define USAR6Tx_RX_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOC_CLK_ENABLE()
#define USAR6Tx_TX_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOC_CLK_ENABLE() 

#define USAR6Tx_FORCE_RESET()             __HAL_RCC_USART6_FORCE_RESET()
#define USAR6Tx_RELEASE_RESET()           __HAL_RCC_USART6_RELEASE_RESET()

/* Definition for USARTx Pins */
#define USAR6Tx_TX_PIN                    GPIO_PIN_6
#define USAR6Tx_TX_GPIO_PORT              GPIOC  
#define USAR6Tx_TX_AF                     GPIO_AF8_USART6
#define USAR6Tx_RX_PIN                    GPIO_PIN_7
#define USAR6Tx_RX_GPIO_PORT              GPIOC
#define USAR6Tx_RX_AF                     GPIO_AF8_USART6
/* STM32 uart driver */
struct drv_uart
{
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart)
{
    ...
    if (huart->Instance == USART2)
    {
        ...
        /*##-2- Configure peripheral GPIO ##########################################*/  
        /* UART TX GPIO pin configuration  */
        GPIO_InitStruct.Pin       = USAR1Tx_TX_PIN;
        GPIO_InitStruct.Mode      = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull      = GPIO_PULLUP;
        GPIO_InitStruct.Speed     = GPIO_SPEED_FAST;
        GPIO_InitStruct.Alternate = USAR1Tx_TX_AF;

        HAL_GPIO_Init(USAR1Tx_TX_GPIO_PORT, &GPIO_InitStruct);
        
        /* UART RX GPIO pin configuration  */
        GPIO_InitStruct.Pin = USAR1Tx_RX_PIN;
        GPIO_InitStruct.Alternate = USAR1Tx_RX_AF;
        
        HAL_GPIO_Init(USAR1Tx_RX_GPIO_PORT, &GPIO_InitStruct);
		...
		else if(huart->Instance == USART6)
		{
			/*##-1- Enable peripherals and GPIO Clocks #################################*/
        /* Enable GPIO TX/RX clock */
        USAR6Tx_TX_GPIO_CLK_ENABLE();
        USAR6Tx_RX_GPIO_CLK_ENABLE();
        ...
        /*##-2- Configure peripheral GPIO ##########################################*/  
        /* UART TX GPIO pin configuration  */
        GPIO_InitStruct.Pin       = USAR6Tx_TX_PIN;
        GPIO_InitStruct.Mode      = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull      = GPIO_PULLUP;
        GPIO_InitStruct.Speed     = GPIO_SPEED_FAST;
        GPIO_InitStruct.Alternate = USARTx_TX_AF;

        HAL_GPIO_Init(USAR6Tx_TX_GPIO_PORT, &GPIO_InitStruct);
        
        /* UART RX GPIO pin configuration  */
        GPIO_InitStruct.Pin = USAR6Tx_RX_PIN;
        GPIO_InitStruct.Alternate = USARTx_RX_AF;
        
        HAL_GPIO_Init(USAR6Tx_RX_GPIO_PORT, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef *huart)
{
		...
		else if (huart->Instance == USART1)
    {
        /*##-1- Reset peripherals ##################################################*/
        USAR1Tx_FORCE_RESET();
        USAR1Tx_RELEASE_RESET();

        /*##-2- Disable peripherals and GPIO Clocks #################################*/
        /* Configure UART Tx as alternate function  */
        HAL_GPIO_DeInit(USAR1Tx_TX_GPIO_PORT, USAR1Tx_TX_PIN);
        /* Configure UART Rx as alternate function  */
        HAL_GPIO_DeInit(USAR1Tx_RX_GPIO_PORT, USAR1Tx_RX_PIN);
		...
		else if (huart->Instance == USART6)
    {
        /*##-1- Reset peripherals ##################################################*/
        USAR6Tx_FORCE_RESET();
        USAR6Tx_RELEASE_RESET();

        /*##-2- Disable peripherals and GPIO Clocks #################################*/
        /* Configure UART Tx as alternate function  */
        HAL_GPIO_DeInit(USAR6Tx_TX_GPIO_PORT, USAR6Tx_TX_PIN);
        /* Configure UART Rx as alternate function  */
        HAL_GPIO_DeInit(USAR6Tx_RX_GPIO_PORT, USAR6Tx_RX_PIN);
