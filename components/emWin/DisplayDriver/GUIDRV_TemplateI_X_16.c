...
*       _SetPixelIndex
*/
static void _SetPixelIndex(DRIVER_CONTEXT * pContext, int x, int y, int PixelIndex) {
  /*
  U32 Off;

  x    += pContext->FirstSEG;
  y    += pContext->FirstCOM;
  Off   = XY2OFF(pContext, x, y);
  //
...
*       _GetPixelIndex
*/
static unsigned int _GetPixelIndex(DRIVER_CONTEXT * pContext, int x, int y) {
  /*
